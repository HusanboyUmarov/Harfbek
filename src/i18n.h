...
enum StrId {
    ...
    // sozlamalar
    S_SET_TITLE, S_SET_LANGUAGE, S_SET_TRIGGER,
    S_SET_STARTUP, S_SET_SAVE, S_SET_CANCEL,
    S_SET_CURRENT, S_SET_APOSTROPHE,

    // trigger nomlari (faqat sinalgan tugmalar ro'yxati)
